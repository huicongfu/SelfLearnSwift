...
class SevenWeekVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    let dataArray = ["第一个-传感器","第二个-多线程","第二个-UIKit Dynamics"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            ...
            let vc = SevenWeekTwoDemo.init(collectionViewLayout: layout)
